...
#[no_mangle]
pub extern "C" fn rust_example_bind(ctx: *mut ::std::os::raw::c_void, parent_device: *mut zx_device_t) -> zx_status_t {
    ...
    let example_device = parent_device.add_device("rust-example");
