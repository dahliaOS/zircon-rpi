...
#ifndef SRC_STORAGE_BLOCK_DRIVERS_BLOCK_VERITY_EXTRA_H_
#define SRC_STORAGE_BLOCK_DRIVERS_BLOCK_VERITY_EXTRA_H_
...
#endif  // SRC_STORAGE_BLOCK_DRIVERS_BLOCK_VERITY_EXTRA_H_
