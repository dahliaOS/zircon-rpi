...
void ArmIspDeviceTester::TestCallbacks(fuchsia_camera_test_TestReport& report) {
  ...
  isp_->full_resolution_dma_->OnPrimaryFrameWritten();
  isp_->full_resolution_dma_->OnSecondaryFrameWritten();
  ...
  isp_->downscaled_dma_->OnPrimaryFrameWritten();
  isp_->downscaled_dma_->OnSecondaryFrameWritten();
