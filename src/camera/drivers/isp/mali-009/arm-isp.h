...
class ArmIspDevice : public IspDeviceType,
 ...
 public:
  ...
  // Release a frame that was being used by a consumer
 ...
 private:
  ...
  bool first_frame_processed_ = true;
  ...
  bool full_resolution_streaming_ = false;
  bool downscaled_streaming_ = false;
