...
#ifndef SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA2_VIRTUAL_CAMERA_CONTROL_H_
#define SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA2_VIRTUAL_CAMERA_CONTROL_H_
...
#endif  // SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA2_VIRTUAL_CAMERA_CONTROL_H_
