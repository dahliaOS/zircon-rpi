...
class GenericAccessService final {
 public:
  ...
  static constexpr UUID kServiceUUID = UUID(static_cast<uint16_t>(0x1800));
  static constexpr gatt::IdType kDisplayNameId = 0;
  static constexpr UUID kDisplayNameUUID = UUID(static_cast<uint16_t>(0x2a00));
  static constexpr gatt::IdType kAppearanceId = 1;
  static constexpr UUID kAppearanceUUID = UUID(static_cast<uint16_t>(0x2a01));
  ...
  static constexpr UUID kPeripheralPreferredConnectionParametersUUID =
      UUID(static_cast<uint16_t>(0x2a04));
