...
pub(crate) struct BoundedQueue<T> {
    ...
    // Inspect Data
    size_metric: finspect::UintProperty,
    len_metric: finspect::UintProperty,
}
...
mod tests {
    use {
        super::*,
        fuchsia_inspect::{assert_inspect_tree, vmo as finspect},
        std::time::Duration,
    };
    ...
    fn test_bounded_queue_inspect() {
        let inspect = finspect::Inspector::new().unwrap();
