...
// This is false by default unless vk_shader_info_statistics_set_enabled(true)
// is called.
bool
vk_shader_info_amd_statistics_enabled(void);

// Enable AMD shader info extension. Should be called when the corresponding
// device extension was enabled when creating a Vulkan instance.
void
...
// |names| is an array of |count| strings naming each pipeline for output.
void
