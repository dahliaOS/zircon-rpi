...
lion_cub_paths(spn_path_builder_t pb, uint32_t * const path_count)
{
  ...
  spn(path_builder_move_to(pb, 1.0f, 1.0f));
  spn(path_builder_line_to(pb, 9.0f, 4.0f));
  spn(path_builder_line_to(pb, 1.0f, 4.0f));
  spn(path_builder_line_to(pb, 1.0f, 1.0f));
  ...
  spn(path_builder_move_to(pb, x, y));
  spn(path_builder_line_to(pb, x + w, y));
  spn(path_builder_line_to(pb, x + w, y + h));
  spn(path_builder_line_to(pb, x, y + h));
  spn(path_builder_line_to(pb, x, y));
...
#if 1
  {
    ...
    for (uint32_t ii = 0; ii < count; ii++)
      {
        float r = (float)(ii % rows);
        float c = (float)(ii / rows);

        float const x = 16.0f * c + 1.0f;
        float const y = 16.0f * r + 1.0f;

        spn(path_builder_move_to(pb, x, y));

        spn(path_builder_line_to(pb, x + w, y + 4.0f));
        spn(path_builder_line_to(pb, x, y + 4.0f));
        spn(path_builder_line_to(pb, x, y));
      }
    spn(path_builder_end(pb, paths + path_idx++));
  }
  ...
  spn(path_builder_move_to(pb, 1.3f, 101.3f));
  spn(path_builder_line_to(pb, 19.3f, 104.3f));
  spn(path_builder_line_to(pb, 1.3f, 104.3f));
  spn(path_builder_line_to(pb, 1.3f, 101.3f));

  spn(path_builder_end(pb, paths + path_idx++));
#endif

#define SPN_RECT_X (32.0f * 16.0f + 1.0f)
#define SPN_RECT_Y 0.0f

#if 0
  spn(path_builder_begin(pb));

  spn(path_builder_move_to(pb, 0.0f, SPN_RECT_Y + 4.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 4.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 12.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 12.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 4.0f));

#if 1
  spn(path_builder_move_to(pb, 0.0f, SPN_RECT_Y + 4.0f + 16.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 4.0f + 16.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 12.0f + 16.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 12.0f + 16.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 4.0f + 16.0f));

  spn(path_builder_move_to(pb, 0.0f, SPN_RECT_Y + 4.0f + 32.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 4.0f + 32.0f));
  spn(path_builder_line_to(pb, SPN_RECT_X, SPN_RECT_Y + 12.0f + 32.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 12.0f + 32.0f));
  spn(path_builder_line_to(pb, 0.0f, SPN_RECT_Y + 4.0f + 32.0f));
#endif
...
#define SPN_RECT_Y 256.0f
  ...
  spn(path_builder_move_to(pb, 1.3f, 206.3f));
  spn(path_builder_line_to(pb, 19.3f, 209.3f));
  spn(path_builder_line_to(pb, 1.3f, 209.3f));
  spn(path_builder_line_to(pb, 1.3f, 206.3f));
  ...
  spn(path_builder_move_to(pb, 1.3f, 1.3f));
  spn(path_builder_line_to(pb, 9.3f, 4.3f));
  spn(path_builder_line_to(pb, 1.3f, 4.3f));
  spn(path_builder_line_to(pb, 1.3f, 1.3f));
  ...
  spn(path_builder_move_to(pb, 1.0f, 33.0f));
  spn(path_builder_line_to(pb, 9.0f, 36.0f));
  spn(path_builder_line_to(pb, 1.0f, 36.0f));
  spn(path_builder_line_to(pb, 1.0f, 33.0f));
  ...
  spn(path_builder_move_to(pb, 1.0f, 4.0f));
  spn(path_builder_line_to(pb, 4.0f, 1.0f));
  spn(path_builder_line_to(pb, 7.0f, 4.0f));
  spn(path_builder_line_to(pb, 4.0f, 7.0f));
  spn(path_builder_line_to(pb, 1.0f, 4.0f));
  ...
  spn(path_builder_move_to(pb, 4.0f, 8.0f));
  spn(path_builder_line_to(pb, 16.0f, 4.0f));
  spn(path_builder_line_to(pb, 28.0f, 8.0f));
  spn(path_builder_line_to(pb, 16.0f, 12.0f));
  spn(path_builder_line_to(pb, 4.0f, 8.0f));
  ...
  spn(path_builder_move_to(pb, 4.0f, 40.0f));
  spn(path_builder_line_to(pb, 16.0f, 36.0f));
  spn(path_builder_line_to(pb, 28.0f, 40.0f));
  spn(path_builder_line_to(pb, 16.0f, 44.0f));
  spn(path_builder_line_to(pb, 4.0f, 40.0f));
  ...
  spn(path_builder_move_to(pb, 4.0f, 8.0f));
  spn(path_builder_line_to(pb, 32.0f, 4.0f));
  spn(path_builder_line_to(pb, 44.0f, 8.0f));
  spn(path_builder_line_to(pb, 32.0f, 12.0f));
  spn(path_builder_line_to(pb, 4.0f, 8.0f));
  ...
  spn(path_builder_move_to(pb, 0.0f, 8.0f));
  spn(path_builder_line_to(pb, 16.0f, 0.0f));
  spn(path_builder_line_to(pb, 32.0f, 8.0f));
  spn(path_builder_line_to(pb, 16.0f, 16.0f));
  ...
  spn(path_builder_move_to(pb, 0.3f, 8.3f));
  spn(path_builder_line_to(pb, 16.3f, 0.3f));
  spn(path_builder_line_to(pb, 32.3f, 8.3f));
  spn(path_builder_line_to(pb, 16.3f, 16.3f));
  spn(path_builder_line_to(pb, 0.3f, 8.3f));
  ...
  spn(path_builder_move_to(pb, 0.0f, 16.0f));
  spn(path_builder_line_to(pb, 4.0f, 0.0f));
  spn(path_builder_line_to(pb, 8.0f, 16.0f));
  spn(path_builder_line_to(pb, 4.0f, 32.0f));
  spn(path_builder_line_to(pb, 0.0f, 16.0f));
  ...
  spn(path_builder_move_to(pb, 0.3f, 16.3f));
  spn(path_builder_line_to(pb, 4.3f, 0.3f));
  spn(path_builder_line_to(pb, 8.3f, 16.3f));
  spn(path_builder_line_to(pb, 4.3f, 32.3f));
  spn(path_builder_line_to(pb, 0.3f, 16.3f));
  ...
  spn(path_builder_move_to(pb, 0.3f, 32.3f));
  spn(path_builder_line_to(pb, 32.3f, 32.3f));
  spn(path_builder_line_to(pb, 32.3f, 0.3f));
  spn(path_builder_line_to(pb, 0.3f, 0.3f));
  spn(path_builder_line_to(pb, 0.3f, 32.3f));
  ...
  spn(path_builder_move_to(pb, 4.0f, 4.0f));
  spn(path_builder_line_to(pb, 324.0f, 4.0f + (1.0 / 32.0f)));
  spn(path_builder_line_to(pb, 324.0f, 4.0f + (1.0 / 32.0f) + 8.0f));
  spn(path_builder_line_to(pb, 4.0f, 12.0f));
  ...
  for (uint32_t jj = 0; jj < rotations; jj++)
    {
      ...
      transform_stack_push_rotate_xy(ts, theta_step * (float)jj, 238.0f / 2.0f, 377.0f + 50.0f);
