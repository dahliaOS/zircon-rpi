...
#define SPN_BLOCK_POOL_BLOCK_DWORDS_LOG2                          8
#define SPN_BLOCK_POOL_SUBBLOCK_DWORDS_LOG2                       SPN_TILE_HEIGHT_LOG2
...
#define SPN_KERNEL_FILLS_SCAN_ROWS                                4
...
#define SPN_KERNEL_RASTERS_PREFIX_SUBGROUP_SIZE                   SPN_DEVICE_SUBGROUP_SIZE
...
#define SPN_KERNEL_PLACE_SUBGROUP_SIZE                            SPN_DEVICE_SUBGROUP_SIZE
