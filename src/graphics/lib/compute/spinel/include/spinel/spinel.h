...
//
// Deprecate the flush functions while Spinel is being bootstrapped.
//

#define SPN_DEPRECATED __attribute__((deprecated("Used for bootstrapping and will be removed.")))
...
spn_result_t
spn_path_builder_flush(spn_path_builder_t path_builder) SPN_DEPRECATED;
...
spn_result_t
spn_raster_builder_flush(spn_raster_builder_t raster_builder) SPN_DEPRECATED;
...
//
// TODO(allanmac) -- do we want a per-place clip?
//
