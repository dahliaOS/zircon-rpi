...
struct spn_context
{
  ...
  spn_result_t (*reset)(struct spn_device * const device);

  spn_result_t (*yield)(struct spn_device * const device);

  spn_result_t (*wait)(struct spn_device * const device);

  spn_result_t (*drain)(struct spn_device * const device);
