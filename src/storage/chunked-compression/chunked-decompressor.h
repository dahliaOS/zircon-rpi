...
#ifndef SRC_STORAGE_CHUNKED_COMPRESSION_CHUNKED_DECOMPRESSOR_H_
#define SRC_STORAGE_CHUNKED_COMPRESSION_CHUNKED_DECOMPRESSOR_H_
...
class ChunkedDecompressor {
 public:
  ChunkedDecompressor();
  ~ChunkedDecompressor();
  ChunkedDecompressor(ChunkedDecompressor&& o);
  ChunkedDecompressor& operator=(ChunkedDecompressor&& o);
  FXL_DISALLOW_COPY_AND_ASSIGN(ChunkedDecompressor);
...
#endif  // SRC_STORAGE_CHUNKED_COMPRESSION_CHUNKED_DECOMPRESSOR_H_
