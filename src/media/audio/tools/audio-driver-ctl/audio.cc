...
void usage(const char* prog_name) {
  ...
  printf("tone   : Params : [<freq>] [<duration>] [<amplitude>]\n"
         ...
         "         at %d mSec.  Default is %.1f Hz for infinite seconds until a key is pressed.\n"
  ...
  printf("noise  : Params : [<duration>]\n"
         ...
         "         given in seconds and floored at %d mSec.  Defaults to infinite seconds\n"
  ...
  printf("record : Params : <file> [duration]\n"
         ...
         "         Defaults to infinite seconds until a key is pressed.\n");
  // clang-format on
}
