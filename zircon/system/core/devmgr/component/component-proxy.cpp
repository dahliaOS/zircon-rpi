...
zx_status_t ComponentProxy::Rpc(const proxy_req_t* req, size_t req_length, proxy_rsp_t* resp,
...
zx_status_t ComponentProxy::I2cGetInterrupt(uint32_t flags, zx::interrupt* out_irq) {
    ...
    rpc_i2c_rsp_t resp = {};
    req.header.proto_id = ZX_PROTOCOL_I2C;
    req.header.op = I2C_GET_INTERRUPT;
...
zx_status_t ComponentProxy::SysmemConnect(zx::channel allocator2_request) {
    ...
    return Rpc(&req, sizeof(req), &resp, sizeof(resp), &handle, 1, nullptr, 0, nullptr);
}
