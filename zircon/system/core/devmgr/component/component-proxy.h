...
public:
    ...
    zx_status_t Rpc(const proxy_req_t* req, size_t req_length, proxy_rsp_t* resp,
    ...
    inline zx_status_t Rpc(const proxy_req_t* req, size_t req_length, proxy_rsp_t* resp,
                           size_t resp_length) {
