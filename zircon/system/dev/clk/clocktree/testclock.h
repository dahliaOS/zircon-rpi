...
class TestFailClock : public BaseClock {
  public:
    ...
    zx_status_t SetRate(const Hertz rate, const Hertz parent_rate) override { return ZX_ERR_INTERNAL; }
    zx_status_t QuerySupportedRate(const Hertz max, const Hertz parent_rate, Hertz* out) override { return ZX_ERR_INTERNAL; }
