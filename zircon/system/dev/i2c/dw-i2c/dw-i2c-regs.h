...
#define DW_I2C_SS_SCL_HCNT_VALUE ((DW_I2C_CLK_RATE_KHZ * (DW_I2C_SS_THD_STA + DW_I2C_SDA_TF)) + 500000) / 1000000 - 3
#define DW_I2C_FS_SCL_HCNT_VALUE ((DW_I2C_CLK_RATE_KHZ * (DW_I2C_FS_THD_STA + DW_I2C_SDA_TF)) + 500000) / 1000000 - 3
// IC_[FS]S_SCL_LCNT + 1 >= IC_CLK * (tLOW + tf)
#define DW_I2C_SS_SCL_LCNT_VALUE ((DW_I2C_CLK_RATE_KHZ * (DW_I2C_SS_TLOW + DW_I2C_SCL_TF)) + 500000) / 1000000 - 1
#define DW_I2C_FS_SCL_LCNT_VALUE ((DW_I2C_CLK_RATE_KHZ * (DW_I2C_FS_TLOW + DW_I2C_SCL_TF)) + 500000) / 1000000 - 1
