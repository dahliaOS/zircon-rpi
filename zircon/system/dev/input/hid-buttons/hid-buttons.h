...
private:
    ...
    virtual zx_status_t GetGpioProtocol(zx_device_t* device, uint32_t index, void* out_protocol) {
        return device_get_protocol(device, ZX_PROTOCOL_GPIO, out_protocol);
    }
