...
public:
    ...
    zx_status_t DsiImplIsPoweredUp(bool* out_powered_up);
    ...
    zx_status_t DsiImplPhyPowerDown() { return ZX_OK; }
    zx_status_t DsiImplPhySendCode(uint32_t code, uint32_t parameter) { return ZX_OK; }
    zx_status_t DsiImplPhyWaitForReady() { return ZX_OK; }
