...
// This wrapper encompasses both MsiDispoatcher MsiAllocationDispatcher due
...
class msi final : public object<msi> {
 public:
  ...
  static zx_status_t create(const msi& msi, uint32_t msi_id, const vmo& vmo, size_t vmo_offset,
