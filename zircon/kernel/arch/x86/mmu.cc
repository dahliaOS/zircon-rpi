...
void x86_mmu_init(void) {
  ...
  // TODO(ZX-1526): Currently KPTI disables Global pages; we might be able to do better, to use
  // global pages for all user-pages, to avoid implicit TLB entry invalidations on user<->kernel
  // transitions.
  //
