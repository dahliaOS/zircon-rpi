...
LK_PDEV_INIT(msm_uart_init_early, KDRV_MSM_GENI_UART, msm_uart_init_early, LK_INIT_LEVEL_PLATFORM_EARLY)
LK_PDEV_INIT(msm_uart_init, KDRV_MSM_GENI_UART, msm_uart_init, LK_INIT_LEVEL_PLATFORM)
