...
static void append_board_boot_item(zbi_header_t* bootdata) {
    ...
    // add kernel drivers
    append_boot_item(bootdata, ZBI_TYPE_KERNEL_DRIVER, KDRV_MSM_GENI_UART, &uart_driver,
                    sizeof(uart_driver));
